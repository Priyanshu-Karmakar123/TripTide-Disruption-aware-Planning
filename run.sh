...
export OUTPUT_DIR="/scratch/sg/Priyanshu/TripCraft-main/zero_shot_cot_qwen_7day"
...
export CSV_FILE="/scratch/sg/Priyanshu/TripCraft-main/disruption_7day_annotation.csv"
